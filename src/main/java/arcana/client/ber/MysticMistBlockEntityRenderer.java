...
public class MysticMistBlockEntityRenderer implements BlockEntityRenderer<MysticMistBlockEntity>{
	...
	public static final Identifier RAIN = Identifier.of("textures/environment/rain.png");
	public static final Identifier SNOW = Identifier.of("textures/environment/snow.png");
	...
	public void render(MysticMistBlockEntity entity,
		...
		vc = Tessellator.getInstance().begin(VertexFormat.DrawMode.QUADS, VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL);
