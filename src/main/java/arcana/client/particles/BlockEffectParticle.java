...
public class BlockEffectParticle extends Particle{
	
	private final Sprite sprite;
	
	protected BlockEffectParticle(ClientWorld world, double x, double y, double z, Sprite sprite){
		super(world, x, y, z);
		this.sprite = sprite;
		maxAge = 30;
	}
	...
	public void buildGeometry(VertexConsumer vc, Camera camera, float tickDelta){
		float s = 1.01f, o = (s - 1) / 2;
		int alpha1 = (int)((1 - (age + tickDelta) / (maxAge + 1)) * 200);
	...
	public static final class Factory implements ParticleFactory<DefaultParticleType>{
		...
		public @NotNull Particle createParticle(DefaultParticleType parameters,
		                                        ClientWorld world,
		                                        double x,
		                                        double y,
		                                        double z,
		                                        ...
		                                        double velocityY,
		                                        double velocityZ){
			return new BlockEffectParticle(world, x, y, z, sprite.getSprite(world.random));
		}
	}
}