...
public class DistilleryPathfinderScreen extends HandledScreen<DistilleryPathfinderScreenHandler>{
	
	private static final Identifier texture = arcId("textures/gui/container/distillery_pathfinder.png");
	
	public DistilleryPathfinderScreen(DistilleryPathfinderScreenHandler handler, PlayerInventory inventory, Text title){
